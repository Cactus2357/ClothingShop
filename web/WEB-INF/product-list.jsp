<%-- Document : product-list Created on : Sep 28, 2024, 10:00:23 PM Author : hi --%> <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <%@ taglib prefix = "fn" uri = "http://java.sun.com/jsp/jstl/functions" %> <%@ taglib
  prefix = "fmt" uri="http://java.sun.com/jsp/jstl/fmt" %> <%@page contentType="text/html" pageEncoding="UTF-8"%>
  <!DOCTYPE html>
      ...
      <main class="container-fluid p-5 px-3">
        <div class="row g-3">
          <div class="col-12 col-md-4 col-xl-3">
            <aside class="container-fluid sticky-top pb-3" style="top: 4.5rem">
          ...
          <div class="col-12 col-md-8 col-xl-9">
            <div class="sticky-top" style="top: 3.5rem">
              <form action="${pageContext.request.contextPath}/product-list">
                <!-- !!! -->
                <div class="row bg-body mb-3 pt-3">
                  <div class="col-xl-6 mb-3">
                    ...
                    <div class="row g-0 align-items-center">
                      <div class="col">
                        <input class="form-control rounded-pill pe-5" type="search" list="searchList" placeholder="Search..." name="query" value="${query}" />
                      </div>
                      <div class="col-auto">
                        <button class="btn btn-sm btn-outline-success border-0 rounded-circle" style="margin-left: -2.2rem" type="submit">
            ...
            <div class="container-fluid mb-3">
              <!-- !!! -->
              <div class="row row-cols-1 row-cols-lg-2 row-cols-xxl-3 g-3 mb-3" id="product-list" data-masonry='{"percentPosition": true }'>
                        ...
                        <div class="mt-2">
                          ...
                          <span class="float-end d-flex gap-1">
                            <c:if test="${sessionScope.user ne null}">
                              <a href="#" class="btn btn-outline-primary border-0 rounded-circle disabled"> <i class="bi bi-cart"></i> </a>
                            </c:if>
